...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://sso.txssc.txstate.edu/oauth2/authorize';
  options.tokenURL = options.tokenURL || 'https://sso.txssc.txstate.edu/oauth2/access_token';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  this._oauth2.getProtectedResource('https://sso.txssc.txstate.edu/me', accessToken, function (err, body, res) {
